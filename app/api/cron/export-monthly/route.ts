...
// (i.e. the month that just closed) for every client. Captured to Sentry on
// failure (L8 launch phase) — a monthly job that silently fails is invisible
// for up to a month otherwise.
